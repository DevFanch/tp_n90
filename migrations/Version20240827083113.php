 ...
 */
final class Version20240827083113 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO category (name) VALUES (\'categorie à update\')');
        $this->addSql('ALTER TABLE wish ADD category_id INT NOT NULL DEFAULT 1');
